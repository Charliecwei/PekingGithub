...
# -*- coding: utf-8 -*-
"""
Created on Mon Jan 13 16:58:41 2020
...
def DS(N,r):
    ...
    V = FiniteElement("RT", mesh.ufl_cell(), r)
    ...
    # g_D
    g_D = Expression(("(cos(2*pi*x[0])-1)*(cos(2*pi*x[1])-1)","sin(2*pi*x[0])*sin(2*pi*x[1])"),degree=4)
...
print("\t\tThe error of Lagrange-RT r=",r)       
